import{t as e}from"./chunks/ChibiManager.js";import{n as t}from"./chunks/ChibiConfigs.js";(function(){if(document.getElementById(`chibi-goobers-host`))return;let n=document.createElement(`div`);n.id=`chibi-goobers-host`,n.style.setProperty(`position`,`fixed`,`important`),n.style.setProperty(`bottom`,`0`,`important`),n.style.setProperty(`left`,`0`,`important`),n.style.setProperty(`width`,`100vw`,`important`),n.style.setProperty(`height`,`100vh`,`important`),n.style.setProperty(`pointer-events`,`none`,`important`),n.style.setProperty(`z-index`,`2147483640`,`important`),n.style.setProperty(`overflow`,`hidden`,`important`),document.body.appendChild(n);let r=n.attachShadow({mode:`open`}),i=document.createElement(`style`);i.textContent=`
  ...
  `,r.appendChild(i);let a=document.createElement(`div`);a.id=`chibi-goobers-root`;let o=document.createElement(`canvas`);o.id=`chibi-canvas`,a.appendChild(o),r.appendChild(a);let s={...t};function c(t){let n=new e(o,a,t),r=typeof browser<`u`&&browser.runtime?browser:typeof chrome<`u`&&chrome.runtime?chrome:null;return r&&r.runtime&&r.runtime.onMessage&&r.runtime.onMessage.addListener((e,t,r)=>(e.type===`SETTINGS_UPDATE`?(n.updateSettings(e.settings),r({status:`ok`})):e.type===`ACTION_FEED`?(n.dropSnack(),r({status:`ok`})):e.type===`ACTION_STAMPEDE`?(n.startStampede(),r({status:`ok`})):e.type===`ACTION_NAP`?(n.groupNap(),r({status:`ok`})):e.type===`ACTION_WAKE`?(n.wakeAll(),r({status:`ok`})):e.type===`ACTION_WAVE`&&(n.waveAll(),r({status:`ok`})),!0)),window.addEventListener(`keydown`,e=>{e.altKey&&(e.key===`c`||e.key===`C`)&&n.dropSnack()}),n}let l=typeof browser<`u`&&browser.storage?browser.storage:typeof chrome<`u`&&chrome.storage?chrome.storage:null;l&&l.sync?l.sync.get(`chibiSettings`,e=>{e&&e.chibiSettings&&(s={...s,...e.chibiSettings}),c(s)}):c(s)})();